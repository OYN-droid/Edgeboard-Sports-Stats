...
def main() -> int:
    manifest = extract_json(ROOT / "tools/illustration-qa/motorsports-illustration-showcase-batch-6.js", "/* motorsports-showcase-json-start */", "/* motorsports-showcase-json-end */")
